...
import type { UserFindAllData, UserCreateData, UserCreateResponse, UserFindOneData, UserRemoveData, UserRemoveResponse, UserUpdateData, UserUpdateResponse, ItemFindAllData, ItemCreateData, ItemSearchData, ItemRemoveData, ItemFindOneData, ItemUpdateData, OrderFindAllData, OrderCreateData, OrderCreateResponse, OrderRemoveData, OrderRemoveResponse, OrderFindOneData, OrderUpdateData, OrderUpdateResponse, AuthSignInData, AuthSignInResponse2, AuthGetProfileData, CashRegisterGetOpenCashRegisterData, CashRegisterOpenData, CashRegisterCloseData, CashRegisterRegisterTransactionData } from '../types.gen';
import { userFindAll, userCreate, userFindOne, userRemove, userUpdate, itemFindAll, itemCreate, itemSearch, itemRemove, itemFindOne, itemUpdate, orderFindAll, orderCreate, orderRemove, orderFindOne, orderUpdate, authSignIn, authGetProfile, cashRegisterGetOpenCashRegister, cashRegisterOpen, cashRegisterClose, cashRegisterRegisterTransaction, client } from '../sdk.gen';
...
export const authGetProfileQueryKey = (options?: Options<AuthGetProfileData>) => [
...
export const cashRegisterOpenQueryKey = (options: Options<CashRegisterOpenData>) => [
...
export const cashRegisterCloseQueryKey = (options: Options<CashRegisterCloseData>) => [
